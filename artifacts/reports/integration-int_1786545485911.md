...
- **Run ID**: `int_1786545485911`
- **Trạng thái**: ❌ FAILED
- **Thời gian chạy**: `1.63s`
...
| Step 2 | Start Test Database | ✅ OK | 8ms | Database sẵn sàng (Mode: FILE_SQLITE): file:D:\AIAUTOTEST1-latest\artifacts\runs\int_1786545485911\sandbox-integration.sqlite |
...
| Step 8 | Execute Integration Tests | ❌ FAIL | 1613ms | Vitest JSON Report: Total=1, Pass=0, Fail=1 |
