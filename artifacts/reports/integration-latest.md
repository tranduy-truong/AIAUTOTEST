...
- **Run ID**: `int_1786543381787`
- **Trạng thái**: ✅ PASSED
- **Thời gian chạy**: `16.75s`
...
| Step 5 | Start External Mocks | ✅ OK | 3ms | Mocks đã chạy trước khi start server (IN_PROCESS_MSW). |
...
| Step 8 | Execute Integration Tests | ✅ OK | 16738ms | Vitest run kết thúc. Pass: 1, Fail: 0 |
