...
- **Run ID**: `int_1786545468112`
- **Trạng thái**: ❌ FAILED
- **Thời gian chạy**: `1.75s`
...
| Step 2 | Start Test Database | ✅ OK | 9ms | Database sẵn sàng (Mode: FILE_SQLITE): file:D:\AIAUTOTEST1-latest\.testkit\runs\int_1786545468112\sandbox-integration.sqlite |
...
| Step 5 | Start External Mocks | ✅ OK | 3ms | Mocks sẵn sàng (IN_PROCESS_MSW). |
...
| Step 8 | Execute Integration Tests | ❌ FAIL | 1737ms | Vitest JSON Report: Total=1, Pass=0, Fail=1 |
