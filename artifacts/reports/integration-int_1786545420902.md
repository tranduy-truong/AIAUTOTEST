...
- **Run ID**: `int_1786545420902`
- **Trạng thái**: ❌ FAILED
- **Thời gian chạy**: `1.35s`
...
| Step 2 | Start Test Database | ✅ OK | 10ms | Database sẵn sàng (Mode: FILE_SQLITE): file:D:\AIAUTOTEST1-latest\.testkit\runs\int_1786545420902\sandbox-integration.sqlite |
...
| Step 8 | Execute Integration Tests | ❌ FAIL | 1333ms | Vitest JSON Report: Total=1, Pass=0, Fail=1 |
