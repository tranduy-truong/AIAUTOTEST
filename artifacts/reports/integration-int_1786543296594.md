...
- **Run ID**: `int_1786543296594`
- **Trạng thái**: ❌ FAILED
- **Thời gian chạy**: `4.18s`
...
| --- | --- | --- | --- | --- |
| Step 1 | Security Preflight & Config Validation | ✅ OK | 0ms | Config hợp lệ. Đã kiểm tra không có Production DATABASE_URL. |
...
| Step 8 | Execute Integration Tests | ❌ FAIL | 4180ms | Vitest run kết thúc. Pass: 0, Fail: 1 |
