...
- **Run ID**: `int_1786545537268`
- **Trạng thái**: ✅ PASSED
- **Thời gian chạy**: `9.49s`
...
| Step 2 | Start Test Database | ✅ OK | 8ms | Database sẵn sàng (Mode: FILE_SQLITE): file:D:\AIAUTOTEST1-latest\artifacts\runs\int_1786545537268\sandbox-integration.sqlite |
...
| Step 8 | Execute Integration Tests | ✅ OK | 9481ms | Vitest JSON Report: Total=1, Pass=1, Fail=0 |
