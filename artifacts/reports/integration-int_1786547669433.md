...
- **Run ID**: `int_1786547669433`
- **Trạng thái**: ✅ PASSED
- **Thời gian chạy**: `16.87s`
...
| Step 2 | Start Test Database | ✅ OK | 23ms | Database sẵn sàng (Mode: FILE_SQLITE): file:D:\AIAUTOTEST1-latest\artifacts\runs\int_1786547669433\sandbox-integration.sqlite |
...
| Step 8 | Execute Integration Tests | ✅ OK | 16839ms | Vitest JSON Report: Total=1, Pass=1, Fail=0 |
