...
- **Run ID**: `int_1786544310877`
- **Trạng thái**: ✅ PASSED
- **Thời gian chạy**: `10.47s`
...
| Step 2 | Start Test Database | ✅ OK | 17ms | Database đã khởi chạy thành công: file::memory:?cache=shared |
...
| Step 5 | Start External Mocks | ✅ OK | 38ms | Mocks sẵn sàng (IN_PROCESS_MSW). |
...
| Step 8 | Execute Integration Tests | ✅ OK | 10407ms | Vitest JSON Report: Total=1, Pass=1, Fail=0 |
